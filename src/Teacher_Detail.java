...
public class Teacher_Detail extends JFrame implements ActionListener{
    ...
    public Teacher_Detail()  {
        ...
        super("Update the Detail of Teacher");
        setLayout(null);
        ...
        //name, father's name, age, dob, address, mobile, email, xth%, xiith%, aadhar no, empid, course, branch
        }catch(Exception e) {
        e.printStackTrace();}
        ...
        l1 = new JLabel("Enter Roll No to Delete the Teacher  :");
        ...
        l3 = new JLabel("Update Detail Of Teacher :");
      ...
      public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource() == b1) {
            try{
                String q1 = "delete from teacher where empid='"+a+"'";
