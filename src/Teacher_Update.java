...
public class Teacher_Update extends JFrame implements ActionListener{
    JLabel lb,lb1,lb2,lb3,lb4,lb5,lb6,lb7,lb8,lb9,lb10,lb11,lb12,lb13,lb14,lb15,lb16,lb17,lab1,lab,lab2,labh;
    ...
    public Teacher_Update() throws HeadlessException {
        ...
        lb14 = new JLabel("Updating The Detail Of Teacher");
        lb14.setFont(new Font("Verdana",Font.BOLD,20));
        lb14.setBounds(130,0,500,50);
        
        labh = new JLabel(" Enter The Emp  Number :");
        labh.setFont(new Font("Verdana",Font.BOLD,20));
        labh.setBounds(100,30,300,50);
         try{
            Connection c = Connection2.getConnection();
            String q3 = "SELECT * FROM teacher ";
            ...
            rs.beforeFirst();
            while(rs.next() ) {
                roll[i] = rs.getString("empid");
                i++;
            }
            c3 = new JComboBox<String>(roll);
            c3.setBounds(400, 40, 150, 30);
        }catch(Exception e) {
        e.printStackTrace();}
